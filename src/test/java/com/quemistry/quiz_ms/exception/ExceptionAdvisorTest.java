...
class ExceptionAdvisorTest {
    ...
    void handleApplicationException_ReturnsResponseEntityWithCorrectStatusAndMessage() {
        ...
        ResponseEntity<ExceptionResponse> response = exceptionAdvisor.handleApplicationException(ex, webRequest);

        assertThat(response.getStatusCode()).isEqualTo(HttpStatus.BAD_REQUEST);
        assertThat(Objects.requireNonNull(response.getBody()).getMessage()).isEqualTo("Application error");
    }
